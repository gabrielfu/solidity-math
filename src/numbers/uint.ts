...
// alias functions
export const uint8 = (number: BNInput) => Uint8._new(number) as Uint8;
export const uint16 = (number: BNInput) => Uint16._new(number) as Uint16;
export const uint24 = (number: BNInput) => Uint24._new(number) as Uint24;
export const uint32 = (number: BNInput) => Uint32._new(number) as Uint32;
export const uint40 = (number: BNInput) => Uint40._new(number) as Uint40;
export const uint48 = (number: BNInput) => Uint48._new(number) as Uint48;
export const uint56 = (number: BNInput) => Uint56._new(number) as Uint56;
export const uint64 = (number: BNInput) => Uint64._new(number) as Uint64;
export const uint72 = (number: BNInput) => Uint72._new(number) as Uint72;
export const uint80 = (number: BNInput) => Uint80._new(number) as Uint80;
export const uint88 = (number: BNInput) => Uint88._new(number) as Uint88;
export const uint96 = (number: BNInput) => Uint96._new(number) as Uint96;
export const uint104 = (number: BNInput) => Uint104._new(number) as Uint104;
export const uint112 = (number: BNInput) => Uint112._new(number) as Uint112;
export const uint120 = (number: BNInput) => Uint120._new(number) as Uint120;
export const uint128 = (number: BNInput) => Uint128._new(number) as Uint128;
export const uint136 = (number: BNInput) => Uint136._new(number) as Uint136;
export const uint144 = (number: BNInput) => Uint144._new(number) as Uint144;
export const uint152 = (number: BNInput) => Uint152._new(number) as Uint152;
export const uint160 = (number: BNInput) => Uint160._new(number) as Uint160;
export const uint168 = (number: BNInput) => Uint168._new(number) as Uint168;
export const uint176 = (number: BNInput) => Uint176._new(number) as Uint176;
export const uint184 = (number: BNInput) => Uint184._new(number) as Uint184;
export const uint192 = (number: BNInput) => Uint192._new(number) as Uint192;
export const uint200 = (number: BNInput) => Uint200._new(number) as Uint200;
export const uint208 = (number: BNInput) => Uint208._new(number) as Uint208;
export const uint216 = (number: BNInput) => Uint216._new(number) as Uint216;
export const uint224 = (number: BNInput) => Uint224._new(number) as Uint224;
export const uint232 = (number: BNInput) => Uint232._new(number) as Uint232;
export const uint240 = (number: BNInput) => Uint240._new(number) as Uint240;
export const uint248 = (number: BNInput) => Uint248._new(number) as Uint248;
export const uint256 = (number: BNInput) => Uint256._new(number) as Uint256;